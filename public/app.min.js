...
const jss = __webpack_require__(2);
const reflow = __webpack_require__(4);
const {spinnerJss, maskJss, fillerJss} = __webpack_require__(3);
function countdownStart(clockDOM){
...
const {countdownStart} = __webpack_require__(0);

let clockDOM = document.getElementById('stopwatch');
countdownStart(clockDOM);
let stopwatchButtonDom = document.getElementById('stopwatch-btn');
